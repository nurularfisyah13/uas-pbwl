...
@section('content')
<div class="container">
    <h3 class="mb-4">Tambah Pembeli</h3>
    <div class="row justify-content-center">
        <form class="mb-5" method="post" action="{{ url('/pembeli/store') }}">
            @csrf
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Handphone" name="hp_pembeli" required>
                    </div>
                </div>
            </div>
            <div class="row mb-5">
                ...
                <div class="col-sm-5">
                    <div class="input-group mb-3">
                        <textarea class="form-control" name="alamat_pembeli" cols="30" rows="5" style="resize: none;" placeholder="Alamat"></textarea>
                    </div>
                </div>
            </div>
